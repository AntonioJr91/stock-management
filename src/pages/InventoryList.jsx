...
export default function InventoryList() {
  ...
  const { products, handleDeleteProductButton, handEditProductButton } = useContext(ProductsContext);

  const [isOpen, setIsOpen] = useState(false);

  const handleOpenModal = (id) => {
    setIsOpen(true);
    handEditProductButton(id);
  }
  ...
  return (
    ...
    isOpen ? <EditProductModal closeModal={handleCloseModal} /> :
